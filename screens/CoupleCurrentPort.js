...
class CoupleCurrentPort extends React.Component {
    static navigationOptions = {
        title: 'Couple Portfolio',
    };

    state = {
      list: trackCouple.state.history,
      original: trackCouple.state.history,
      bool: true,
      itemLs: trackCouple.state.itemH,
      itemTemp: "",
      costLs: trackCouple.state.costH,
      costTemp: "",
      catLs: trackCouple.state.catH,
      catTemp: "",
      userSelection: "",
    }
    ...
    render() {
        ...
        return(
            <View style={styles.container}>
              <LinearGradient
                colors={['transparent', 'rgba(255,100,200,0.8)']}
                style={{
                  position: 'absolute',
                  left: 0,
                  right: 0,
              ...
              <View style = {styles.getStartedContainer}>
                ...
                <Text style = {styles.header3}> ${trackCouple.state.expenses}</Text>
              </View>
              <Animatable.View
                          style={styles.footer}
                      ...
                      >
              <LinearGradient
                    colors={['rgba(255,100,200,0.8)', 'rgba(216, 247, 237, 0.65)',]}
                    style={{
                          position: 'absolute',
                          left: 0,
                          right: 0,
...
const styles = StyleSheet.create({
    container: {
      ...
      catContainer1: {
        ...
        borderBottomWidth: 1,
        borderRightWidth: StyleSheet.hairlineWidth,
        backgroundColor: 'rgba(254, 194, 235, 0.86)'
      },
      ...
      catContainer2: {
        ...
        borderLeftWidth: 1,
        borderRightWidth: 1,
        backgroundColor: 'rgba(251, 156, 221, 0.86)'
      },
      ...
      catContainer3: {
        ...
        backgroundColor: 'rgba(248, 87, 197, 0.86)'
      },
...
export default CoupleCurrentPort